locals {
  ...
  image = {
    matrix          = "ghcr.io/matrix-construct/tuwunel:v1.5.0-release-all-x86_64-v3-linux-gnu"
    signal-bridge   = "dock.mau.dev/mautrix/signal:v0.2601.0"
    whatsapp-bridge = "dock.mau.dev/mautrix/whatsapp:v0.2601.0"
  }
}
