locals {
  ...
  image = {
    immich           = "ghcr.io/immich-app/immich-server:v2.5.6"
    machine-learning = "ghcr.io/immich-app/immich-machine-learning:v2.5.6"
    ...
    task "server" {
      ...
      config {
        ...
        volumes = [
          ...
          "${local.nas}/opencloud/storage/users/users/8bdc36f1-6829-443a-bd0e-eb9cfef018a4/Bilder:/libraries/user-1:ro",
